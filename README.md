...
11. [JavaScript实现数组原型方法forEach、map、filter、some、reduce](https://github.com/GGXXMM/FE-Knowledge/issues/98)
12. [JavaScript模拟实现new操作符](https://github.com/GGXXMM/FE-Knowledge/issues/10)
13. [JavaScript模拟实现Object.create](https://github.com/GGXXMM/FE-Knowledge/issues/99)
14. [JavaScript模拟实现Object.assign](https://github.com/GGXXMM/FE-Knowledge/issues/100)
15. [JavaScript模拟实现JSON.stringify](https://github.com/GGXXMM/FE-Knowledge/issues/11)
16. [JavaScript模拟实现JSON.parse](https://github.com/GGXXMM/FE-Knowledge/issues/12)
17. [JavaScript模拟实现instanceOf](https://github.com/GGXXMM/FE-Knowledge/issues/13)
18. [JavaScript模拟实现call、apply、bind](https://github.com/GGXXMM/FE-Knowledge/issues/14)
19. [JavaScript实现函数防抖和节流](https://github.com/GGXXMM/FE-Knowledge/issues/16)
20. [JavaScript实现函数柯里化](https://github.com/GGXXMM/FE-Knowledge/issues/15)
21. [JavaScript实现偏函数](https://github.com/GGXXMM/FE-Knowledge/issues/101)
